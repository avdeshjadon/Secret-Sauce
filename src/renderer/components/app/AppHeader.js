...
export class AppHeader extends LitElement {
    ...
    async _checkForUpdates() {
        try {
            const currentVersion = await secretSauce.getVersion();
            const response = await fetch('https://raw.githubusercontent.com/avdeshjadon/secret-sauce/refs/heads/master/package.json');
    ...
    getViewTitle() {
        const titles = {
            onboarding: 'Welcome to Secret Sauce',
            main: 'Secret Sauce',
            customize: 'Customize',
            help: 'Help & Shortcuts',
            history: 'Conversation History',
            advanced: 'Advanced Tools',
            assistant: 'Secret Sauce',
        };
        return titles[this.currentView] || 'Secret Sauce';
    }
                    ...
                    ${this.currentView === 'assistant'
                        ? html`
                              <button @click=${this.onHideToggleClick} class="button">
                                  Hide&nbsp;&nbsp;<span class="key" style="pointer-events: none;">${secretSauce.isMacOS ? 'Cmd' : 'Ctrl'}</span
