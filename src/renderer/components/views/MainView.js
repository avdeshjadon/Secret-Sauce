...
export class MainView extends LitElement {
    ...
    async _saveOllamaModel(val) {
        ...
        await secretSauce.storage.updatePreference('ollamaModel', val);
        this.requestUpdate();
    }
        ...
        return html`
            <div class="form-wrapper">
                ${this._mode === 'local' ? html`
                    <div class="title-row">
                        <div class="page-title">Secret Sauce <span class="mode-suffix">Local AI</span></div>
                        <button class="help-btn" @click=${() => { this._showLocalHelp = !this._showLocalHelp; }}>${this._showLocalHelp ? closeIcon : helpIcon}</button>
                    </div>
                ` : html`
                    <div class="page-title">
                        ${html`Secret Sauce <span class="mode-suffix">BYOK</span>`}
                    </div>
                `}
